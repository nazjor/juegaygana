                ...
                <div style='width: 600px; margin: 0 auto; background-color: #fff; border-radius: 10px; box-shadow: 0 4px 10px rgba(0, 0, 0, 0.1);'>
                    ...
                    <div style='padding: 20px;'>
                        ...
                        <p style='text-align: center; margin: 20px 0;'>
                            <a href='$enlaceRecibo' style='display: inline-block; background-color: #007bff; color: #fff; text-decoration: none; padding: 10px 20px; border-radius: 5px;'>Ver boletos</a>
                        </p>
