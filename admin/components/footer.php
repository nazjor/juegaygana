    ...
    <!-- Plugin Js -->
    <script src="<?php echo HOST_ADMIN;?>assets/libs/simplebar/simplebar.min.js?v1=2"></script>
    <script src="<?php echo HOST_ADMIN;?>assets/libs/lucide/umd/lucide.min.js?v1=2"></script>
    <script src="<?php echo HOST_ADMIN;?>assets/libs/@frostui/tailwindcss/frostui.js?v1=2"></script>    
    <script src="<?php echo HOST_ADMIN;?>assets/js/app.js?v1=2"></script>
